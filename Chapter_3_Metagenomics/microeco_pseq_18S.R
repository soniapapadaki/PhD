...
#
# Description:
#   Microbiome data analysis in microeco R package, using a phyloseq object
#	generated from total RNA data processed via phyloFlash. Produces relative 
#	abundance plots (phylum and family level).
#
# Notes:
#   This script is adapted from sections 4.1 in the microeco R package tutorial:
