# Chapter 2: The taxonomic composition and diversity of endolithic and soil crust microbial communities in gypsum samples from Svalbard, Norway

Code for Chapter 2 of my doctoral thesis: "Traces of Microbial Life and Activity in Arctic Endolithic Habitats".
...
| `elemental analyses` | Python scripts for additional elemental analysis that didn't make it into the thesis. |
