...
euk_microdata$save_abund(dirpath = 'euk_taxa_abund_raw_AVERAGED',
                          merge_all = TRUE, sep = '\t', quote = FALSE)

euk_microdata$cal_abund()
euk_microdata$save_abund(dirpath = 'euk_taxa_abund_AVERAGED',
                          merge_all = TRUE, sep = '\t', quote = FALSE)
...
write.csv(envfit_table_pp, "euk_envfit_results.csv", row.names = FALSE)
