...
setwd("C:/Users/PC/Documents/R/ENDOLITHS_SC/microeco")
#rm(list=ls())
#graphics.off()
...
#import data
prok_abund_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2024/endoliths_sc_16S/table-filtered.qza" #Count table
metadata_file_path <- "C:/Users/PC/Documents/R/ENDOLITHS_SC/microeco/endolith_metadata.tsv" #Metadata file
prok_taxonomy_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2024/endoliths_sc_16S/taxonomy-v1.qza" #Taxonomy table
prok_tree_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2024/endoliths_sc_16S/rooted-tree.qza" #Phylogenetic tree
prok_rep_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2024/endoliths_sc_16S/rep-seqs-filtered.qza" #Sequences

#construct microtable object
qiime2meco(prok_abund_file_path)
prok_microdata <- qiime2meco(prok_abund_file_path, sample_table = metadata_file_path, taxonomy_table = prok_taxonomy_file_path, phylo_tree = prok_tree_data, rep_fasta = prok_rep_data)
prok_microdata
...
#create bar plot comparing relative abundance of top 8 phyla between sample types and sites
...
euk_abund_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2024/endoliths_sc_18S/table-filtered-no-malassezia.qza" #Count table
euk_taxonomy_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2024/endoliths_sc_18S/taxonomy.qza" #Taxonomy table
euk_tree_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2024/endoliths_sc_18S/rooted-tree.qza" #Phylogenetic tree
euk_rep_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2024/endoliths_sc_18S/rep-seqs-filtered.qza" #Sequences

qiime2meco(euk_abund_file_path)
euk_microdata <- qiime2meco(euk_abund_file_path, sample_table = metadata_file_path, taxonomy_table = euk_taxonomy_file_path, phylo_tree = euk_tree_data, rep_fasta = euk_rep_data)
euk_microdata
...
prok25_taxonomy_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_16S_2025/taxonomy.qza" #Taxonomy table
cy_abund_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_16S_2025/table-filtered-only-cyano.qza" #Count table
cy_rep_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_16S_2025/rep-seqs-filtered-only-cyano.qza" #Sequences

qiime2meco(cy_abund_file_path)
cy_microdata <- qiime2meco(cy_abund_file_path, sample_table = metadata_file_path, taxonomy_table = prok25_taxonomy_file_path, rep_fasta = cy_rep_data)
cy_microdata
...
prot_abund_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_16S_2025/table-filtered-only-pro.qza" #Count table
prot_rep_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_16S_2025/rep-seqs-filtered-only-pro.qza" #Sequences

qiime2meco(prot_abund_file_path)
prot_microdata <- qiime2meco(prot_abund_file_path, sample_table = metadata_file_path, taxonomy_table = prok25_taxonomy_file_path, rep_fasta = prot_rep_data)
prot_microdata
...
act_abund_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_16S_2025/table-filtered-only-act.qza" #Count table
act_rep_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_16S_2025/rep-seqs-filtered-only-act.qza" #Sequences

qiime2meco(act_abund_file_path)
act_microdata <- qiime2meco(act_abund_file_path, sample_table = metadata_file_path, taxonomy_table = prok25_taxonomy_file_path, rep_fasta = act_rep_data)
act_microdata
...
bda_abund_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_16S_2025/table-filtered-only-bda.qza" #Count table
bda_rep_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_16S_2025/rep-seqs-filtered-only-bda.qza" #Sequences

qiime2meco(bda_abund_file_path)
bda_microdata <- qiime2meco(bda_abund_file_path, sample_table = metadata_file_path, taxonomy_table = prok25_taxonomy_file_path, rep_fasta = bda_rep_data)
bda_microdata
...
euk25_taxonomy_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_18S_2025/taxonomy.qza" #Taxonomy table
asc_abund_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_18S_2025/table-filtered-only-asc.qza" #Count table
asc_rep_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_18S_2025/rep-seqs-filtered-only-asc.qza" #Sequences

qiime2meco(asc_abund_file_path)
asc_microdata <- qiime2meco(asc_abund_file_path, sample_table = metadata_file_path, taxonomy_table = euk25_taxonomy_file_path, rep_fasta = asc_rep_data)
asc_microdata
...
cpt_abund_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_18S_2025/table-filtered-only-cpt.qza" #Count table
cpt_rep_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_18S_2025/rep-seqs-filtered-only-cpt.qza" #Sequences

qiime2meco(cpt_abund_file_path)
cpt_microdata <- qiime2meco(cpt_abund_file_path, sample_table = metadata_file_path, taxonomy_table = euk25_taxonomy_file_path, rep_fasta = cpt_rep_data)
cpt_microdata
...
cil_abund_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_18S_2025/table-filtered-only-cil.qza" #Count table
cil_rep_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_18S_2025/rep-seqs-filtered-only-cil.qza" #Sequences

qiime2meco(cil_abund_file_path)
cil_microdata <- qiime2meco(cil_abund_file_path, sample_table = metadata_file_path, taxonomy_table = euk25_taxonomy_file_path, rep_fasta = cil_rep_data)
cil_microdata
...
bas_abund_file_path <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_18S_2025/table-filtered-only-bas.qza" #Count table
bas_rep_data <- "C:/Users/PC/Documents/QIIME2/ENDOLITHS_SC_2025/endoliths_sc_18S_2025/rep-seqs-filtered-only-bas.qza" #Sequences

qiime2meco(bas_abund_file_path)
bas_microdata <- qiime2meco(bas_abund_file_path, sample_table = metadata_file_path, taxonomy_table = euk25_taxonomy_file_path, rep_fasta = bas_rep_data)
bas_microdata
...
# Calculate alpha diversity (NULL indicating to calculate all alpha diversity measures) and save to a .csv file
...
p_Obs <- p2$plot_alpha(measure = 'Observed', add = "jitter", xtext_angle = 0, add_sig = FALSE) + 
  facet_wrap2(~Measure) + 
...
p_Sh <- p2$plot_alpha(measure = 'Shannon', add = "jitter", xtext_angle = 0, add_sig = FALSE) + 
  facet_wrap2(~Measure) + 
  theme(axis.title.y = element_text(size = 14),
        axis.text.y = element_text(size = 10, ),axis.text.x = element_blank(), 
        axis.ticks.x.bottom = element_blank(), 
...
e_Sh <- e2$plot_alpha(measure = 'Shannon', add = "jitter", xtext_angle = 0, add_sig = FALSE) + 
  facet_wrap2(~Measure) + 
  theme(axis.title.y = element_text(size = 14),
        axis.text.y = element_text(size = 10, ),axis.text.x = element_blank(), 
        axis.ticks.x.bottom = element_blank(), 
...
# export image as 700 x 350 (for output of 875 x 437)

combined_alpha_p <- p_Obs + p_Sh + p_Inv & theme(legend.position = "right")
combined_alpha_p + plot_layout(axis_titles = "collect", guides = "collect")

combined_alpha_e <- e_Obs + e_Sh + e_Inv & theme(legend.position = "right")
combined_alpha_e + plot_layout(axis_titles = "collect", guides = "collect")

# Save alpha diversity stats as .csv

write.csv(p2[["data_stat"]], "C:/Users/PC/Documents/R/ENDOLITHS_SC/microeco/16S/alpha_diversity/alpha_div_stats.csv")
write.csv(p2[["res_diff"]], "C:/Users/PC/Documents/R/ENDOLITHS_SC/microeco/16S/alpha_diversity/alpha_div_p.csv")
write.csv(e2[["data_stat"]], "C:/Users/PC/Documents/R/ENDOLITHS_SC/microeco/18S/alpha_diversity/alpha_div_stats.csv")
write.csv(e2[["res_diff"]], "C:/Users/PC/Documents/R/ENDOLITHS_SC/microeco/18S/alpha_diversity/alpha_div_p.csv")


# Create simplified plots for presentations, save as 400 x 400

p_Sh_ppt <- p2$plot_alpha(measure = 'Shannon', add = "jitter", xtext_angle = 0, add_sig = FALSE) + 
  theme(axis.title.y = element_blank(),
        axis.text.y = element_text(size = 10), 
        axis.ticks.x.bottom = element_blank()) +
  scale_x_discrete(labels = c("Endolith", "Soil crust"))

p_Inv_ppt <- p2$plot_alpha(measure = 'InvSimpson', add = "jitter", xtext_angle = 0, add_sig_text_size = 5, y_start = 0.05) + 
  theme(axis.title.y = element_blank(),
        axis.text.y = element_text(size = 10), 
        axis.ticks.x.bottom = element_blank()) +
  scale_x_discrete(labels = c("Endolith", "Soil crust"))

e_Sh_ppt <- e2$plot_alpha(measure = 'Shannon', add = "jitter", xtext_angle = 0, add_sig = FALSE) + 
  theme(axis.title.y = element_blank(),
        axis.text.y = element_text(size = 10), 
        axis.ticks.x.bottom = element_blank()) +
  scale_x_discrete(labels = c("Endolith", "Soil crust"))

e_Inv_ppt <- e2$plot_alpha(measure = 'InvSimpson', add = "jitter", xtext_angle = 0, add_sig_text_size = 5, y_start = 0.05) + 
  theme(axis.title.y = element_blank(),
        axis.text.y = element_text(size = 10), 
        axis.ticks.x.bottom = element_blank()) +
  scale_x_discrete(labels = c("Endolith", "Soil crust"))
...
p3 <- trans_beta$new(dataset = prok_microdata, group = 'sample_type', measure = 'wei_unifrac')
...
p_pcoa_base <- p3$plot_ordination(plot_color = 'sample_site', plot_shape = 'sample_type',
...
p_pcoa_final <- p_pcoa_base +
  stat_ellipse(aes(group = sample_type), linetype = "dashed", color = "black", linewidth = 0.5) +
  theme_bw() +
  theme(axis.title.y = element_text(size = 12), axis.title.x = element_text(size = 12), 
        legend.text = element_text(size = 12), plot.subtitle = element_text(hjust = 0, 
...
e3 <- trans_beta$new(dataset = euk_microdata, group = 'sample_type', measure = 'wei_unifrac')
...
e_pcoa_base <- e3$plot_ordination(plot_color = 'sample_site', plot_shape = 'sample_type',
                                  plot_type = c('point'), point_size = 3, 
                                  shape_values = c(19, 17), 
                                  color_values = paletteer_d("ggthemes::gdoc"))
...
combined_pcoa <- p_pcoa_final + e_pcoa_final & theme(legend.position = "right")
combined_pcoa + plot_layout(axis_titles = "collect", guides = "collect")
